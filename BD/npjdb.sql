...
--
-- Host: 127.0.0.1
-- Generation Time: 27-Fev-2016 às 12:47
...
INSERT INTO `atendimento_defensoria` (`idAtendimento_Defensoria`, `descricaoAtendimentoDefensoria`, `data`, `deferido`, `Assistido_Defensoria_idAssistidoDefensoria`, `Requerido_idRequerido`, `Documentos_Atendimento_idDocumentos`, `Usuario_idUsuario`, `Assunto_Atendimento_idAssunto_Atendimento`, `status`, `visualizado`) VALUES
(7, 'Ação de investigação de Paternidade', '2015-10-14 10:31:00', NULL, 32, 28, NULL, 1, 1, 'aberto', 0),
(8, 'Ação de Indenização c/c Dano Moral', '2015-09-21 17:13:36', NULL, 33, 29, NULL, 1, 2, 'Não Aprovado', 0),
(9, 'Ação de investigação de Paternidade', '2015-11-02 17:34:15', NULL, 34, 30, NULL, 1, 1, 'esperando aprovacao', 0),
(10, 'Ação de Execução de Alimentos', '2015-11-02 18:04:50', NULL, 32, 28, NULL, 1, 3, 'concluído', 0),
(11, 'Ação de investigação de Paternidade', '2015-09-21 17:13:36', NULL, 33, 29, NULL, 1, 1, 'concluído', 0),
(14, 'Ação de Aliments', '2015-11-05 09:42:55', NULL, 37, 33, NULL, 1, 10, 'aberto', 0),
(15, '', '2015-11-06 23:56:58', NULL, 38, 34, NULL, 2, 1, 'aberto', 0);
...
(1, 'Anderson Thiago', 'thiago', '123', '4', 'ADSN2014.1', 'N', '(91)98349-0122', 'Suporte/Desenvolvedor', 'dist/img/Thiago.jpg', 'eng.thiagolima@hotmail.com', 1, 'Castanhal', 'Pará', '"As pessoas que são loucas o suficiente para achar que podem mudar o Mundo, são aquelas que o fazem."', 1),
